        ...
        child: SafeArea(
          child: BlocBuilder<DeliveryBloc, DeliveryState>(
            builder: (context, state) {
              final totalEarnings = state is DeliveryLoaded ? state.totalEarnings : HiveService.totalEarnings;
              final completedCount = state is DeliveryLoaded ? state.completedCount : HiveService.completedCount;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CustomText.title('Completed Deliveries', fontSize: Responsive.sp(16), fontWeight: FontWeight.bold),
                        CustomText.caption('${completedOrders.length} records', color: AppColors.grayFont),
                      ],
                    ),
