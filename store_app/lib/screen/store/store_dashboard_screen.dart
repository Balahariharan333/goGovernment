            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildMetricCard('Today\'s Orders', '18', Icons.shopping_bag_outlined, const Color(0xFF2563EB))),
                      SizedBox(width: Responsive.w(12)),
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: Responsive.w(12)),
                      Expanded(child: _buildMetricCard('Active Products', '32 Items', Icons.inventory_2_outlined, const Color(0xFF16A34A))),
                    ],
                  ),
                  ...
                  SizedBox(height: Responsive.h(12)),
                  _buildActionTile(Icons.receipt_long_rounded, 'Order Processing Queue', '3 orders pending fulfillment'),
                  _buildActionTile(Icons.inventory_rounded, 'Stock & Commodities Inventory', 'Update ration & essential stock levels'),
                  _buildActionTile(Icons.account_balance_rounded, 'Settlement Bank Account', '${_store.bankDetails.bankName.isNotEmpty ? _store.bankDetails.bankName : 'Configured'} (IFSC: ${_store.bankDetails.ifscCode})'),
                  _buildActionTile(Icons.access_time_rounded, 'Operating Hours & Holidays', '${_store.timings['open'] ?? '08:00 AM'} - ${_store.timings['close'] ?? '08:30 PM'}'),
                  SizedBox(height: Responsive.h(24)),
                ],
              ),
            ),
